...
class BoiteComptePlus {
    ...
    getData() {
        ...
        if (data.startConstruction)
            this._startConstruction = data.startConstruction;
    ...
    toJSON() {
        ...
        if (this._startConstruction)
            data.startConstruction = this._startConstruction;
    ...
    verifierDonnees() {
        ...
        if (
            ...
            if (
                this._construction.includes("Couveuse") ||
                this._construction.includes("Solarium")
            )
    ...
    recalculeTempsPonte() {
        this._ponte.forEach((ponte) => {
            ponte.exp = moment().add(
                Math.round((moment(ponte.exp).diff(moment()) / 1000) * 0.9),
                "s",
            );
        });
    }
    ...
    afficher() {
        ...
        if (!Utils.comptePlus) {
            ...
            visible == null || visible == "C"
                ? ""
                : $(
                      "#boiteComptePlus .contenu_boite_compte_plus table:eq(0)",
                  ).css("display", "none");
    ...
    majPonte() {
        if (this._ponte.length) {
            ...
            $("#o_progressUnite").progressbar({
                value:
                    ((moment().valueOf() - moment(this._startPonte).valueOf()) *
                        100) /
                    (moment(this._ponte[0].exp).valueOf() -
                        moment(this._startPonte).valueOf()),
            });
            // Ajout du title
            let table = "<table>",
                ...
                if (i == 0)
                    nombreU = Math.ceil(
                        moment(this._ponte[i].exp).diff(moment()) /
                            1000 /
                            (tempsU * Math.pow(0.9, monProfil.getTDP())),
                    );
            ...
            if (tempsR <= 600)
                $("#o_progressUnite").addClass("highlight_success");
        } else {
            $("#o_resteUnite").html(
                "<span class='red_light'>Aucune ponte</span>",
            );
            $("#o_tempsUnite").text("");
    ...
    majConstruction() {
        if (this._construction) {
            ...
            $("#o_progressConstruction").progressbar({
                value:
                    ((moment().valueOf() -
                        moment(this._startConstruction).valueOf()) *
                        100) /
                    (moment(this._expConstruction).valueOf() -
                        moment(this._startConstruction).valueOf()),
            });
            ...
            if (tempsR <= 3600)
                Utils.decreaseTime(tempsR, "o_tempsConstruction");
            if (tempsR <= 600)
                $("#o_progressConstruction").addClass("highlight_success");
        }
        return this;
    }
    /**
    ...
    majRecherche() {
        if (this._recherche) {
            ...
            $("#o_progressRecherche").progressbar({
                value:
                    ((moment().valueOf() -
                        moment(this._startRecherche).valueOf()) *
                        100) /
                    (moment(this._expRecherche).valueOf() -
                        moment(this._startRecherche).valueOf()),
            });
            ...
            if (tempsR <= 600)
                $("#o_progressRecherche").addClass("highlight_success");
        }
        return this;
    }
    /**
    ...
    majAttaque() {
        if (this._attaque.length) {
            ...
            $("#o_progressAttaque").progressbar({
                value:
                    ((moment().valueOf() -
                        moment(this._startAttaque).valueOf()) *
                        100) /
                    (moment(this._attaque[0].exp).valueOf() -
                        moment(this._startAttaque).valueOf()),
            });
            // Ajout du title
            let table = "<table>";
            ...
            if (tempsR <= 600)
                $("#o_progressAttaque").addClass("highlight_success");
        } else {
    ...
    majConvoi() {
        if (this._convoi.length) {
            ...
            $("#o_progressConvoi").progressbar({
                value:
                    ((moment().valueOf() -
                        moment(this._startConvoi).valueOf()) *
                        100) /
                    (moment(this._convoi[0].exp).valueOf() -
                        moment(this._startConvoi).valueOf()),
            });
            // Ajout du title
            ...
            if (tempsR <= 600)
                $("#o_progressConvoi").addClass("highlight_success");
        } else {
    ...
    majChasse() {
        if (this._chasse.length) {
            ...
            $("#o_progressChasse").progressbar({
                value:
                    ((moment().valueOf() -
                        moment(this._startChasse).valueOf()) *
                        100) /
                    (moment(this._chasse[0].exp).valueOf() -
                        moment(this._startChasse).valueOf()),
            });
            // Ajout du title
            ...
            if (tempsR <= 600)
                $("#o_progressChasse").addClass("highlight_success");
        } else {
